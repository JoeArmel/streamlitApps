...
def load_data():
    ...
    df = pd.DataFrame(
        columns=['nom', 'Accronyme', 'market_cap', 'taux_change_1h', 'taux_change_24h', 'taux_change_7j', 'prix',
                 'volume_24h'])
    df['nom'] = nom
...
col2.subheader('Données sur les Prix des Crypto Monnaies Sélectionnées ')
...
col2.subheader('Tableau des Prix du Taux de Change')
...
col3.subheader('Bar plot du Taux de Change')
